    ...
    <div class="row content">
      ...
      <div class="col-sm-3 sidenav">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li class="active"><a href="cli_perfil_aut.php">Autentidar conta</a></li>
      ...
      <div class="col-sm-9">
        ...
        <hr>
        <h2>Autenticar Conta</h2>
        <br><br>
        <div class="col-sm-8">
          <form action="../function/cliente.php" method="post">
            <div class="form-group">
              <label>Informe seu email</label>
              <input class="form-control" required name="senha_a" id="senha_a" type="email" placeholder="Insira seu email">
            </div><p></p>
            <?php
            ...
            ?>
            <button type="submit" name="autenticar" class="btn btn-primary">Enviar</button>
          </form>
        </div>
